...
export default function SessionsTable({ rows = [], onRowClick, pageSize = 12 }) {
          ...
          {paged.map((r) => (
            ...
            >
              ...
              <td className="py-2 px-3">
                {r?.avg_pace_formatted ||
                  (r?.avg_pace_sec_per && r?.pace_basis_m ? `${r.avg_pace_sec_per}s / ${r.pace_basis_m}m` : "-")}
              </td>
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between mt-3">
          ...
          <div className="flex gap-2">
            <button
              className="px-2 py-1 rounded-lg border border-zinc-300 dark:border-zinc-700 text-sm disabled:opacity-50"
